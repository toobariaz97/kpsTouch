...
Plugin URI:https://profiles.wordpress.org/khushwantsidhu/
Version: 1.1
    ...
    function dupcap_shortcode_metabox()
      ...
      if($original_lang == false){
        $original_lang = $wplang;
    		...
    		?>
		    <input type="button" class="dupcap-copy-button button button-primary" data-from_lang="<?php echo $original_lang ?>" name="dupcap_meta_box_text" id="dupcap-copy-button" value="<?php echo __('Duplicate content from ','dupcap'); echo $original_lang ?> " readonly/>
